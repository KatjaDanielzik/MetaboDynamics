...
#include "stanExports_m_ANOVA_partial_pooling.h"

RCPP_MODULE(stan_fit4m_ANOVA_partial_pooling_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_m_ANOVA_partial_pooling")
