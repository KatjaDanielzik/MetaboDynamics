...
#include "stanExports_m_cluster_distances_padded.h"

RCPP_MODULE(stan_fit4m_cluster_distances_padded_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_m_cluster_distances_padded")
