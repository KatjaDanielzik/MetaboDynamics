...
dd_0Gy <- dist(estimates_dynamics[["0Gy"]][,c("mu1.mean","mu2.mean",
                                                "mu3.mean","mu4.mean")],
                 method="euclidean")
...
clust_0Gy <- estimates_dynamics[["0Gy"]][,c("metabolite","condition","mu1.mean","mu2.mean",
                                                "mu3.mean","mu4.mean")]
...
# get distances between vectors
dd_2Gy <- dist(estimates_dynamics[["2Gy"]][,c("mu1.mean","mu2.mean",
                                                "mu3.mean","mu4.mean")],
                 method="euclidean")
# hierachical clustering
...
# assing cluster ID to estimates
clust_2Gy <- estimates_dynamics[["2Gy"]][,c("metabolite","condition","mu1.mean","mu2.mean",
                                                "mu3.mean","mu4.mean")]
...
# get distances between vectors
dd_10Gy <- dist(estimates_dynamics[["10Gy"]][,c("mu1.mean","mu2.mean",
                                                "mu3.mean","mu4.mean")],
                 method="euclidean")
# hierachical clustering
...
clust_cut <- cutree(clust,k=8)
# assing cluster ID to estimates
clust_10Gy <- estimates_dynamics[["10Gy"]][,c("metabolite","condition","mu1.mean","mu2.mean",
                                                "mu3.mean","mu4.mean")]
