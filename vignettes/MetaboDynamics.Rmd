...
## Model dynamics
```{r}
#fits <- fit_dynamics_model(data=intra[intra$dose=="0Gy"&intra$time==1,])
```
This returns a list of model fits that are named by the experimental condition ("0Gy","2Gy","10Gy"). 
