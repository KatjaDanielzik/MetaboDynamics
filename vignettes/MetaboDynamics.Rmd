...
dynamics model will take 10-15 minutes. Total workflow time
...
and they often rely on frequentist statistical methods. Additionally, most tools
are only able to analyze groups of metabolites on a pathway level, potentially
...
With cc = cell counts and apc = metabolite abundance per cell we get:

\begin{align*}
metabolite abundances
con_{m,c,t}&\sim {\sf log_normal}(\mu_{m,c,t},\sigma_{m,c,t}) \\
