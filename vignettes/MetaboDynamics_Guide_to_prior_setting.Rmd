...
Additional to the prior on the mean of log-transformed metabolite abundances **MetaboDynamics**
also allows to set a prior on the standard deviation of log-transformed metabolite abundances `prior_sd_abundance`.

As the observed standard deviation of *metabolite specific* log-transformed metabolite abundances roughly follow an exponential distribution **MetaboDynamics** implements an exponential distribution for the standard deviation.
`prior_sd_abundance`is hereby the *rate* of the exponential distribution of standard deviations.

**Note**: The *expected value*/mean of the exponential distribution is 1/*rate*. **MetaboDynamics** takes as input the *rate* as we found it more intuitive. If your median observed standard deviation is 2, the *rate* is 2 and the mean equals 1/2.
...
**Recommendation:** Set `prior_sd_abundance` to a value slightly larger than the median observed SD to ensure the prior is weakly informative.
...
**Note**: The *expected value*/mean of the exponential distribution is 1/*rate*. **MetaboDynamics** takes as input the *rate* as we found it more intuitive. 
...
**Recommendation:** Set `prior_counts` to a value slightly larger than the median observed counts to ensure the prior is weakly informative.
