...
rm(base_mean,cond,feature,feature_means,feature_data,feature_to_group,feature_variances,
   ...
   group_probabilities,metabolite_candidates,simulated_data)
