...
use_package("stringr","imports",min_version=TRUE)
use_package("KEGGREST","imports",min_version = TRUE)
```
...
## cluster solution of simulated data
```{r}
...
use_data(cluster,overwrite=TRUE)
```
