...
parameters {
  ...
  array[M, t, d] real<lower=0> sigma; // metabolite, time, and dose specific sigma
  array[M, d] real<lower=0> lambda; // metabolite and dose specific lambda (hyperprior for sigma)
}
