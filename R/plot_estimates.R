...
#' by estimates_dynamics() or if data is a SummarizedExperiment estimates
#' must be stored in metadata(data) under "estimates_dynamics"
#' @param data dataframe or SummarizedExperiment used used to fit dynamics model and extract the estimates
